...
module('Acceptance | authentication', function (hooks) {
  ...
  test('visiting /apps while not authenticated redirects to OAuth provider', async function (assert) {
    ...
    let expectedRedirectURL = 'https://5apps.dev/oauth/authorize?client_id=storage-frontend&redirect_uri=http://localhost:7357/dashboard/callback&response_type=token&scope=storage-frontend';
